    ...
    <div className="ide">
      <div className="main-head pr-head ide-head">
        ...
        <div className="agent-actions">
          ...
          {ready && <button className="approve-btn" disabled={pushing} onClick={push}>{pushing ? 'Pushing…' : (task.kind === 'fix' ? '⬆ Push fix to PR' : task.kind === 'resolve' ? '⬆ Push to PR' : '⬆ Push & Open PR')}</button>}
